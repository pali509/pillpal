...
class LoginDep extends StatefulWidget {
  final int id_asociado;
  const LoginDep({Key? key, required this.id_asociado}) : super(key: key);


  @override
  _LoginDepState createState() => _LoginDepState();
}

class _LoginDepState extends State<LoginDep> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Vincular dependiente asociado"),
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    if (await checkUser(email!, password!)) {
                      //Asociar en la BD a este usuario con el supervisor
